...
def run_drift_test():
    ...
    for i in range(1):
        ...
        print(f"Vehiculo: tipo={tipo_vehiculo}, trans={transmision}, elec={es_electrico}")
        ...
        for v in range(5):
            ...
            c_dict = {
                'id': cid, 'estado': estado, 'horas_conduccion_continua': horas,
                'maneja_manual': maneja_manual, 'maneja_automatico': maneja_automatico,
                'maneja_electrico': maneja_electrico, 'maneja_suv': maneja_suv,
                'maneja_camion': maneja_camion, 'distancia_al_origen_metros': dist_metros,
                'ultimo_ping_gps': ping_gps, 'cancelaciones_tardias_24h': random.randint(0, 2)
            }
            choferes_py.append(c_dict)
            print(f"Chofer {v}: {c_dict}")
        ...
        if py_asignado:
            ...
            print(f"PY Reasignado: {py_reasignado}, SQL Reasignado: {sql_reasignado}")
